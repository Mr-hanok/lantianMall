...
- (void)badgeInit
{
    ...
    self.badgeBGColor   = [UIColor yellowColor];
    self.badgeTextColor = [UIColor whiteColor];
    self.badgeFont      = [UIFont systemFontOfSize:6.0];
    self.badgePadding   = 6;
    self.badgeMinSize   = 8;
    self.badgeOriginX   = self.frame.size.width - self.badge.frame.size.width/5*2;
    self.badgeOriginY   = -4;
