...
@interface TosendGoodsViewController ()<UITableViewDelegate,UITableViewDataSource,OrderTableFootViewDelegate>
...
@implementation TosendGoodsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.dataArray = [NSMutableArray array];
    [self updataNewData:self.sendTableView];
...
-(NSInteger)numberOfSectionsInTableView:(UITableView *)tableView
{
    if (self.dataArray.count==0)
    {
        ...
        self.sendTableView.backgroundView = self.backview;
    }
    else
    {
        self.sendTableView.backgroundView = nil;
    }
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [view LoadData:model with:OrderTypesToSend];
    WeakSelf(self)
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    view.delegate = self;
    [view loaddata:model with:OrderTypesToSend withSection:section];
    return view;
}
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    view.orderType = OrderTypesToSend;
...
-(void)refundButtonClickedWithSection:(NSInteger)section
{
    ...
    BuyerOrderModel * model = self.dataArray[section];
    __weak TosendGoodsViewController * weakself = self;
