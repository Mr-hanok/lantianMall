//
//  IntegralHomeGoodsHorizontalCell.m
//  TheProjectFrameWork
//
...
@implementation IntegralHomeGoodsHorizontalCell
...
- (IBAction)convertBtnClick:(UIButton *)sender {
    if ([_delegate respondsToSelector:@selector(integralHomeHorizontalCell:)]) {
        [_delegate integralHomeHorizontalCell:self];
    }
}
