...
//    [[SDImageCache sharedImageCache] clearMemory];
    self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, KScreenBoundWidth, KScreenBoundHeight)];
    self.scrollView.pagingEnabled = YES;
    self.scrollView.userInteractionEnabled = YES;
    self.scrollView.showsHorizontalScrollIndicator = NO;
    
    self.scrollView.contentSize = CGSizeMake(self.imgArr.count*KScreenBoundWidth, KScreenBoundHeight);
...
-(void)addLabels{
    self.sliderLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, KScreenBoundHeight-64-49, 60, 30)];
...
-(void)setPicCurrentIndex:(NSInteger)currentIndex{
    ...
    self.scrollView.contentOffset = CGPointMake(KScreenBoundWidth*currentIndex, 0);
...
-(void)pinGes:(UIPinchGestureRecognizer *)sender{
    ...
    self.scrollView.contentSize = CGSizeMake(self.imgArr.count*KScreenBoundWidth, KScreenBoundHeight*lastScale);
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    int i = scrollView.contentOffset.x/KScreenBoundWidth+1;
    [self loadPhote:i-1];
