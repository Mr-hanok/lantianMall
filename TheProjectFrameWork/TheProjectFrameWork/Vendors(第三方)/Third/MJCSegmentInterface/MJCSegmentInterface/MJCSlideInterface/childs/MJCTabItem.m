    ...
    if (self.imageView.image != nil) {
        if (_imageEffectStyles == 1) {
            ...
            if (_itemImageSize.width == 0 || _itemImageSize.height == 0 ) {
             ...
             self.imageView.jc_x =tabItemCenterX+ self.titleLabel.jc_width/2+10+_leftImageMargin-_rightImageMargin;
             self.imageView.jc_centerY = tabItemCenterY+_topImageMargin-_bottomImageMargin;
        }
    }else{
        [self.titleLabel sizeToFit];
...
//    UILabel *title = [[UILabel alloc]initWithText:@"12"];
//    title.frame = CGRectMake(self.jc_width-20, 5, 20, self.jc_height);
//    [title sizeToFit];
